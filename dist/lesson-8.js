...
class Task {
  constructor() {
    let name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "".concat(Task.getName());
    this.name = name;
  ...
  set done(value) {
    if (typeof value === 'boolean') this._done = value;else console.error("Свойству можно указать только тип Boolean");
  }
